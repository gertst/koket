 ...
 */
class Magestore_RewardPointsBehavior_Model_Actions_Ggplus extends Magestore_RewardPoints_Model_Action_Abstract implements Magestore_RewardPoints_Model_Action_Interface {

    public function getActionLabel() {
        return Mage::helper('rewardpointsbehavior')->__('Receive point(s) for +1 via Google+');
    }
    ...
    public function getPointAmount() {
        $gg = $this->getData('action_object');
//         echo $tw['tw_earn'];
        return (int) $gg['gg_earn'];
    }
    ...
    public function prepareTransaction() {
        ...
        $expireDays = (int) Mage::getStoreConfig(
                        Magestore_RewardPoints_Helper_Calculation_Earning::XML_PATH_EARNING_EXPIRE, $gg['store_id']
        );
