...
/**
 * RewardPointsRule Earning Catalog Mysql4 Collection Model
 * 
 * @category    Magestore
 * @package     Magestore_RewardPointsRule
 * @author      Magestore Developer
 */
class Magestore_RewardPointsRule_Model_Mysql4_Earning_Catalog_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    public function _construct()
    {
        parent::_construct();
        $this->_init('rewardpointsrule/earning_catalog');
    }
     ...
     * @param type $date
     * @return Magestore_RewardPointsRule_Model_Mysql4_Earning_Catalog_Collection
     */
