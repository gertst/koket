 ...
 */
class Magestore_RewardPointsBehavior_Model_Actions_Fblike extends Magestore_RewardPoints_Model_Action_Abstract implements Magestore_RewardPoints_Model_Action_Interface {

    public function getActionLabel() {
        return Mage::helper('rewardpointsbehavior')->__('Receive point(s) for Facebook like');
    }
...
//         echo $tw['tw_earn'];
    ...
    public function prepareTransaction() {
        ...
        $holdDays = (int) Mage::getStoreConfig(
                        Magestore_RewardPoints_Helper_Calculation_Earning::XML_PATH_HOLDING_DAYS, $fb['store_id']
        );
        if ($holdDays > 0) {
        ...
        $expireDays = (int) Mage::getStoreConfig(
                        Magestore_RewardPoints_Helper_Calculation_Earning::XML_PATH_EARNING_EXPIRE, $fb['store_id']
        );
