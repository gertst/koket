...
//         echo $tw['tw_earn'];
    ...
    public function prepareTransaction() {
        ...
        $transactionData = array(
            ...
            'store_id' => $tw['store_id'],
        );

        // Check if transaction need to hold
        $holdDays = (int) Mage::getStoreConfig(
                        Magestore_RewardPoints_Helper_Calculation_Earning::XML_PATH_HOLDING_DAYS, $tw['store_id']
        );
        if ($holdDays > 0) {
        ...
        $expireDays = (int) Mage::getStoreConfig(
                        Magestore_RewardPoints_Helper_Calculation_Earning::XML_PATH_EARNING_EXPIRE, $tw['store_id']
        );
