...
class Magestore_RewardPointsReferFriends_Model_Action_Referfriends extends Magestore_RewardPoints_Model_Action_Abstract implements Magestore_RewardPoints_Model_Action_Interface {
    ...
    public function getTitle() {
        ...
        return Mage::helper('rewardpointsreferfriends')->__('Receive point(s) from Order #%d which is placed through your referring link', $order->getIncrementId());
    }
    ...
    public function getTitleHtml($transaction = null) {
        ...
        return Mage::helper('rewardpointsreferfriends')->__(
                        'Receive point(s) from Order %s which is placed through your referring link', '<a href="' . $editUrl . '" title="'
