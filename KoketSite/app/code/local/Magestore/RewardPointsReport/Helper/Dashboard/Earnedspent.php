 ...
 */
class Magestore_RewardPointsReport_Helper_Dashboard_Earnedspent extends Mage_Adminhtml_Helper_Dashboard_Abstract
{
	protected function _initCollection(){
		$this->_collection = Mage::getResourceModel('rewardpointsreport/transaction_collection')
			->prepareEarnedSpent($this->getParam('period'),0,0);
