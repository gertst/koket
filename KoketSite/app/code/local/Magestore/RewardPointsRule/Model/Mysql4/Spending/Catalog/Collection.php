...
/**
 * RewardPointsRule Spending Catalog Mysql4 Collection Model
 * 
 * @category    Magestore
 * @package     Magestore_RewardPointsRule
...
class Magestore_RewardPointsRule_Model_Mysql4_Spending_Catalog_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    public function _construct()
    {
        parent::_construct();
        $this->_init('rewardpointsrule/spending_catalog');
    }
