  ...
  protected function _prepareForm()
  {
      ...
      $fieldset = $form->addFieldset('points_action_fieldset', array('legend' => Mage::helper('rewardpointsrule')->__('Spending Points')));
        ...
        $fieldset->addField('max_points_spended', 'text', array(
            'label' => Mage::helper('rewardpointsrule')->__('Max points allowed to spendIf empty or zero, there is no limitation.'),
            'title' => Mage::helper('rewardpointsrule')->__('Max points allowed to spendIf empty or zero, there is no limitation.'),
