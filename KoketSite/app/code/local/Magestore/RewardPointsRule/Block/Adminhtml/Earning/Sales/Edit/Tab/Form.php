...
/**
 * RewardPointsRule Earning_Sales Edit Tab Form Block
 * 
 * @category    Magestore
 * @package     Magestore_RewardPoints
 * @author      Magestore Developer
 */
class Magestore_RewardPointsRule_Block_Adminhtml_Earning_Sales_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {

    /**
     * prepare tab form's information
     * 
     * @return Magestore_RewardPointsRule_Block_Adminhtml_Earning_Sales_Edit_Tab_Form
     */
    protected function _prepareForm() {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('general_fieldset', array('legend' => Mage::helper('rewardpointsrule')->__('General information')));
        ...
        $fieldset->addField('sort_order', 'text', array(
            ...
            'note' => Mage::helper('rewardpointsrule')->__('Rule with the highest priority will be applied first.')
        ));
