...
/**
 * RewardPointsRule Earning Sales Grid Block
 * 
 * @category    Magestore
 * @package     Magestore_RewardPoints
 * @author      Magestore Developer
 */
class Magestore_RewardPointsRule_Block_Adminhtml_Earning_Sales_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('salesEarningRuleGrid');
     ...
     * 
     * @return Magestore_RewardPointsRule_Block_Adminhtml_Earning_Sales_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('rewardpointsrule/earning_sales_collection');
