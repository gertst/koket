...
class Magestore_RewardPointsRule_Adminhtml_Earning_CatalogController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function applyRulesAction()
    {
        ...
        $process = Mage::getModel('index/process')->getCollection()
            ->addFieldToFilter('indexer_code', 'rewardpoints_earning_product');
            //->getSelect()->where("indexer_code = ?", 'rewardpoints_earning_product');process/reindexProcess/process/
    ...
    {
        $defaultMessage = Mage::helper('rewardpointsrule')->__('The rule you have added/edited has not been applied. Please click on the Apply Rules in order to see the effect on the catalog.');
