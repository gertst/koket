...
DROP TABLE IF EXISTS {$this->getTable('rewardpoints_earning_product')};

CREATE TABLE {$this->getTable('rewardpoints_earning_product')} (
...
DROP TABLE IF EXISTS {$this->getTable('rewardpoints_earning_catalog')};
CREATE TABLE {$this->getTable('rewardpoints_earning_catalog')} (
...
DROP TABLE IF EXISTS {$this->getTable('rewardpoints_earning_sales')};
CREATE TABLE {$this->getTable('rewardpoints_earning_sales')} (
    `rule_id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS {$this->getTable('rewardpoints_spending_catalog')};
CREATE TABLE {$this->getTable('rewardpoints_spending_catalog')} (
    `rule_id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(255) NULL,
    `description` TEXT NULL,
    `is_active` SMALLINT(6) NULL,
...
DROP TABLE IF EXISTS {$this->getTable('rewardpoints_spending_sales')};
CREATE TABLE {$this->getTable('rewardpoints_spending_sales')} (
    `rule_id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(255) NULL,
    `description` TEXT NULL,
    `is_active` SMALLINT(6) NULL,
