...
class Inchoo_SocialConnect_FacebookController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            //gert: subscribe to newsletter
            # create new subscriber without send an confirmation email
            Mage::getModel('newsletter/subscriber')->setImportMode(true)->subscribe($userInfo->email);

            # get just generated subscriber
            $subscriber = Mage::getModel('newsletter/subscriber')->loadByEmail($userInfo->email);
