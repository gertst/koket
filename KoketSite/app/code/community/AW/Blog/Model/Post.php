...
class AW_Blog_Model_Post extends Mage_Core_Model_Abstract
{
    ...
    public function getPostContent()
    {
        ...
        foreach ($images as $image) {
            $itemData .= $image->getAttribute('src') . "-";
        }

        //print_r( $images[0]->getAttribute('src'));
        return $content . '<div style="display:none;" itemprop="image">' . 'http://www.kokettekatinka.be/media/koket/Logo-Kokette-Katinka-180x180_2x.png' . '</div>';
    }
